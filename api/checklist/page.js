...
<main id="main" class="doc-main">
  <article class="doc-article" data-checklist-result>
    ...
    <div class="cscore-header" data-slot="header" hidden>
      ...
      <div class="cscore-header-row" data-slot="watermark-row" hidden>
        <span class="cscore-watermark" data-slot="watermark">Machine read. Not principal-reviewed.</span>
      </div>
      <span class="cscore-header-pass" data-slot="pass-count" hidden></span>
    </div>

    <section class="cscore-hero" data-slot="hero" hidden aria-labelledby="cscore-hero-h">
      <h2 class="cscore-hero-h sr-only" id="cscore-hero-h">Score and overall read</h2>
    </section>
    ...
    <section class="cscore-twovoices" data-slot="twovoices" hidden>
      <h2 class="doc-h2">Two voices on the <em>same name.</em></h2>
    ...
    <section class="cscore-grid" data-slot="grid" hidden>
      <!-- machine and principal columns rendered by JS; gutter inserted between when both exist -->
    </section>

    <p class="cscore-breadth-line" data-slot="breadth-line" hidden>The model reads <em>breadth.</em> The principal signs <em>conviction.</em> They are not the same job.</p>
    ...
    <section class="subscribe" id="subscribe" hidden data-slot="subscribe-block">
      ...
      <h2 class="subscribe-h">Want the <em>principal-reviewed</em> version when this name lands on coverage?</h2>
    ...
    <p class="doc-p cscore-footnote" data-slot="footnote">
      Generated by Halvren's research tooling. Cited to public filings. Not advice. Not a recommendation. Not a price call. Read <a href="/process">/process</a> for how the desk works.
    </p>
  </article>
</main>
