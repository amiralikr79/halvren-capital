...
def _build_one(op: dict) -> dict:
    ...
    return {
        ...
        "fy25_fcf":         _pick_metric(op, "fcf", "free cash", "funds flow", "net earnings", "afs"),
        "fy25_earnings":    _pick_metric(op, "earnings", "net earnings"),
        "fy25_period":      op.get("fy_snapshot", {}).get("period", "FY 2025"),
        "net_debt_signal":  _pick_metric(op, "net debt", "leverage"),
        ...
        "halvren_read":          op.get("halvren_read"),
